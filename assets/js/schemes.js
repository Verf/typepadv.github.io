...
export const BUILTIN_SCHEMES = {
  ...
  'ling-builtin': {
    key: 'ling-builtin',
    name: '灵铭（内置）',
    codeTable: { url: 'assets/code-tables/mabiao-ling.txt', direction: 'code-left' },
    chaifen: { url: 'assets/data/chaifen-ling.json', cacheKey: 'ling-chaifen-v1' },
    zigen: { url: 'assets/data/zigen-ling.json' },
